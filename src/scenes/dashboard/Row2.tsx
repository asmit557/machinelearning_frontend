...
import { ResponsiveContainer,LineChart,Line,XAxis,YAxis,Tooltip, CartesianGrid, PieChart, Pie, Cell, ScatterChart, Scatter, ZAxis } from 'recharts';
  ...
  return (
     <>
       <DashboardBox gridArea="d">
        <BoxHeader title="Operation vs Non-Operational Expenses"
         sideText='+4%'
         />
       ...
       <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis type="number" 
          dataKey="price" 
          name="price" axisLine={false} tickLine={false} style={{fontSize:"10px"}} tickFormatter={(v)=>`$${v}`}/>
          <YAxis type="number" 
          dataKey="expense" 
          name="expense" axisLine={false} tickLine={false} style={{fontSize:"10px"}} tickFormatter={(v)=>`$${v}`}/>
