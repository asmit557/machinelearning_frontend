...
import { ResponsiveContainer,AreaChart,XAxis,YAxis,Tooltip,Area,Line,CartesianGrid,LineChart,Legend ,Bar,BarChart,Rectangle} from 'recharts';
    ...
    <>
       ...
       <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis tickLine={false} style={{fontSize:"10px"}} domain={[8000,23000]}/>
          <Tooltip />
        ...
        <BoxHeader title="Revenue and Profits"
